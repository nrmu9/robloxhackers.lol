...
const Footer = () => {
  return (
    <footer className="bg-zinc-950 text-white p-4 text-center border-t border-zinc-800 z-10 backdrop-filter backdrop-blur-lg py-4 bg-transparent bg-opacity-0">
